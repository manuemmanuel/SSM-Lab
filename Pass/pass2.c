...
void main() {
    ...
    int locctr, start, prgmLength = 0, length = 0, textstartAddr;
    ...
    if (!prgmlength) {
        printf("Error opening file program length!!\n");
        return;
    }
    ...
    while (strcmp(opcode, "END") != 0) {
        ...
        if (strcmp(opcode, "BYTE") == 0) {
            ...
            // No object code generated for RESB
        } else if (strcmp(opcode, "RESW") == 0) {
            // No object code generated for RESW
        } else {
            rewind(optab);
